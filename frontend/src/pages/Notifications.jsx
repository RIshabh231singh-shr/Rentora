...
import { Bell, CheckCircle2, Clock, X, ChevronDown, Filter, Building2, Wrench, Users } from "lucide-react";
...
function NotifItem({ notif, onApproveBooking, onRejectBooking, onApproveLease, onRejectLease, actioning }) {
...
const FILTERS = ["all", "unread", "bookings", "tenants"];
...
export default function Notifications() {
  ...
  const handleApproveBooking = async (bookingId, notifId) => {
